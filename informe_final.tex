...
\subsection{Caso 1: Perturbación en el Límite de Capacidad ($D = 19$\,$^\circ$C)}
...
\subsection{Caso 2: Falla por Capacidad Excedida y Falla Térmica Crítica ($D = 29.5$\,$^\circ$C)}
