...
\begin{tabular}{lll}
\hline
\textbf{Estado Operativo} & \textbf{Condición de Temperatura} & \textbf{Condición del Actuador} \\ \hline
\textbf{Normal (Verde)}  & $T(t) \le 27$\,$^\circ$C & Actuador con margen ($u < 100\%$) \\ \hline
\textbf{Alerta (Amarillo)} & $27 < T(t) \le 32$\,$^\circ$C & Actuador saturado ($u = 100\%$ por $<30$\,s) \\ 
                             & o bien $T(t) \le 27$\,$^\circ$C & pero manteniendo la consigna segura. \\ \hline
\textbf{Falla (Rojo)}    & $T(t) > 32$\,$^\circ$C (Térmica) & Actuador saturado de forma persistente \\
                             & o bien $T(t) > 27$\,$^\circ$C & ($u = 100\%$ por $t_{\text{sat}} \ge 30$\,s, Capacidad). \\ \hline
\end{tabular}
\end{table}
